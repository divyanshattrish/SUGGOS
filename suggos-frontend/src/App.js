...
const HOMEPAGE_CSS = `
  ...
  .hp-mobile-link { font-size: 1rem; color: var(--stone-light); text-decoration: none; font-weight: 400; }
  ...
  @media (max-width: 900px) {
    ...
    .hp-footer-inner { flex-direction: column !important; align-items: flex-start !important; gap: 1.2rem !important; }
...
const as = {
  overlay: {
    ...
    background: 'rgba(20,18,16,0.7)', animation: 'fadeIn 0.3s ease',
  },
  card: {
  ...
  corner: { position: 'absolute', width: 18, height: 18, border: '2px solid var(--rose)', opacity: 0.8 },
  ...
  iconRing: {
    ...
    display: 'flex', alignItems: 'center', justifyContent: 'center',
    color: 'var(--rose)', animation: 'pulseRing 1.8s ease infinite',
  },
  title: { fontFamily: 'var(--serif)', fontSize: '1.5rem', fontWeight: 400, color: 'var(--ivory)', margin: 0, textAlign: 'center' },
  stepRow: { display: 'flex', alignItems: 'center', gap: '0.5rem', minHeight: 22 },
  stepText: { fontSize: '0.85rem', color: 'var(--stone-light)', fontWeight: 300, animation: 'fadeIn 0.25s ease' },
  dots: { display: 'flex', gap: 4 },
  dot: {
    display: 'inline-block', width: 5, height: 5, borderRadius: '50%',
    background: 'var(--rose)', opacity: 0.4, animation: 'dotBounce 1s ease infinite',
  },
  progressTrack: { width: '100%', height: 4, borderRadius: 100, background: 'rgba(255,255,255,0.08)', overflow: 'hidden' },
  progressFill: {
    height: '100%', borderRadius: 100,
    background: 'linear-gradient(90deg, #c4705a, var(--rose), #f0a090)',
    transition: 'width 0.3s ease', boxShadow: '0 0 8px rgba(232,146,124,0.5)',
  },
  progressLabel: { fontSize: '0.75rem', color: 'var(--stone)', fontWeight: 500, alignSelf: 'flex-end', marginTop: '-0.8rem' },
};
      ...
      <nav style={styles.nav} className="hp-nav">
        ...
        <button className="hp-hamburger" onClick={() => setMenuOpen(o => !o)} aria-label="Menu">
          <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
            {menuOpen
              ? <><line x1="4" y1="4" x2="18" y2="18" stroke="#A8A29E" strokeWidth="2" strokeLinecap="round"/><line x1="18" y1="4" x2="4" y2="18" stroke="#A8A29E" strokeWidth="2" strokeLinecap="round"/></>
              : <><line x1="3" y1="6" x2="19" y2="6" stroke="#A8A29E" strokeWidth="2" strokeLinecap="round"/><line x1="3" y1="11" x2="19" y2="11" stroke="#A8A29E" strokeWidth="2" strokeLinecap="round"/><line x1="3" y1="16" x2="19" y2="16" stroke="#A8A29E" strokeWidth="2" strokeLinecap="round"/></>
            }
          </svg>
        </button>
      </nav>
...
function RoomBefore() {
  return (
    <svg style={styles.roomSvg} viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect width="400" height="300" fill="#201C1A"/><polygon points="0,180 400,180 400,300 0,300" fill="#2A2420"/>
      <line x1="0" y1="210" x2="400" y2="210" stroke="#322C28" strokeWidth="1"/><line x1="0" y1="240" x2="400" y2="240" stroke="#322C28" strokeWidth="1"/><line x1="0" y1="270" x2="400" y2="270" stroke="#322C28" strokeWidth="1"/>
      <line x1="100" y1="180" x2="80" y2="300" stroke="#322C28" strokeWidth="1"/><line x1="200" y1="180" x2="200" y2="300" stroke="#322C28" strokeWidth="1"/><line x1="300" y1="180" x2="320" y2="300" stroke="#322C28" strokeWidth="1"/>
      <rect x="140" y="30" width="120" height="90" rx="2" fill="#1A2030" stroke="#2A3040" strokeWidth="1.5"/>
      <line x1="200" y1="30" x2="200" y2="120" stroke="#2A3040" strokeWidth="1.5"/><line x1="140" y1="75" x2="260" y2="75" stroke="#2A3040" strokeWidth="1.5"/>
      ...
      <rect x="60" y="148" width="30" height="40" rx="2" fill="#4A3A2E"/><rect x="250" y="148" width="30" height="40" rx="2" fill="#4A3A2E"/>
      <ellipse cx="200" cy="185" rx="120" ry="12" fill="#2E2620" stroke="#3A302A" strokeWidth="1"/>
      <rect x="295" y="158" width="45" height="30" rx="2" fill="#2E2820"/><rect x="298" y="148" width="39" height="12" rx="2" fill="#3A342C"/>
      <polygon points="320,148 308,118 332,118" fill="#3A3430"/><rect x="317" y="118" width="6" height="30" fill="#3A3430"/>
    </svg>
  );
}
...
function RoomAfter() {
  return (
    <svg style={styles.roomSvg} viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect width="400" height="300" fill="#2A2220"/><rect x="100" y="0" width="200" height="180" fill="#2E2520"/>
      <polygon points="0,180 400,180 400,300 0,300" fill="#2E2824"/>
      <line x1="0" y1="210" x2="400" y2="210" stroke="#3A3028" strokeWidth="1"/><line x1="0" y1="240" x2="400" y2="240" stroke="#3A3028" strokeWidth="1"/><line x1="0" y1="270" x2="400" y2="270" stroke="#3A3028" strokeWidth="1"/>
      <line x1="100" y1="180" x2="80" y2="300" stroke="#3A3028" strokeWidth="1"/><line x1="200" y1="180" x2="200" y2="300" stroke="#3A3028" strokeWidth="1"/><line x1="300" y1="180" x2="320" y2="300" stroke="#3A3028" strokeWidth="1"/>
      <rect x="140" y="30" width="120" height="90" rx="2" fill="#2A3848" stroke="#3A5060" strokeWidth="1.5"/>
      <line x1="200" y1="30" x2="200" y2="120" stroke="#3A5060" strokeWidth="1.5"/><line x1="140" y1="75" x2="260" y2="75" stroke="#3A5060" strokeWidth="1.5"/>
      <defs><radialGradient id="lampGlow" cx="50%" cy="50%" r="50%"><stop offset="0%" stopColor="#E8A060" stopOpacity="0.3"/><stop offset="100%" stopColor="#E8A060" stopOpacity="0"/></radialGradient></defs>
      ...
      <rect x="55" y="150" width="28" height="36" rx="4" fill="#8A6A50"/><rect x="257" y="150" width="28" height="36" rx="4" fill="#8A6A50"/>
      <rect x="92" y="136" width="44" height="18" rx="8" fill="#C4906A" opacity="0.8"/><rect x="148" y="136" width="44" height="18" rx="8" fill="#E8927C" opacity="0.7"/><rect x="204" y="136" width="44" height="18" rx="8" fill="#C4906A" opacity="0.8"/>
      ...
      <rect x="319" y="112" width="8" height="38" fill="#7A5830"/><circle cx="323" cy="112" r="5" fill="#FFE0A0" opacity="0.9"/>
      <rect x="22" y="158" width="14" height="22" rx="2" fill="#4A3828"/>
      <ellipse cx="29" cy="158" rx="18" ry="22" fill="#3A5030"/><ellipse cx="20" cy="148" rx="12" ry="16" fill="#4A6040"/><ellipse cx="36" cy="145" rx="10" ry="14" fill="#3A5030"/>
      ...
      <line x1="248" y1="35" x2="276" y2="65" stroke="#6A8040" strokeWidth="2" opacity="0.6"/><line x1="276" y1="35" x2="248" y2="65" stroke="#6A8040" strokeWidth="2" opacity="0.4"/>
    </svg>
  );
}
...
function Hero({ onUpload }) {
  ...
  return (
    <section style={styles.hero} className={`hp-hero${dragging ? ' hp-drop-active' : ''}`}
      ...
      {dragging && <div style={styles.dragHint}>📷 Drop your room photo here</div>}
      <div className="hp-room-strip">
        <div style={{ ...styles.roomCard, ...styles.roomBefore }}><RoomBefore /><div style={styles.roomPill}>before</div></div>
        <div style={{ ...styles.roomCard, ...styles.roomAfter }}>
          ...
          <div style={styles.suggestionFloat} className="hp-suggestion-float">
            ...
            Velvet accent sofa<br /><span style={{ color: 'var(--rose)', fontWeight: 600 }}>$649 →</span>
          </div>
...
───────────────────────────────────────── */
const steps = [
  { icon: '📷', title: 'Snap a photo', body: 'Take a quick photo of any room — living room, bedroom, kitchen, anywhere. No special setup needed.' },
  { icon: '✨', title: 'AI reads your space', body: 'SugGos analyzes your room — layout, light, existing furniture, and colour palette — in about 30 seconds.' },
  { icon: '🛒', title: 'Shop the look', body: 'Get personalised furniture suggestions matched to your space, with real products and prices.' },
];
  ...
  return (
    <section style={styles.what} className="hp-what" id="features">
      <div style={styles.whatInner}>
        ...
        <h2 style={{ ...styles.sectionH, color: 'var(--ivory)', maxWidth: 500 }}>Design advice that <em style={{ fontStyle: 'italic' }}>knows</em> your room.</h2>
            ...
            <div style={styles.bentoVisual}>
              {products.map(p => (
                <div key={p.name} style={styles.productRow}>
                  ...
                  <div style={{ flex: 1 }}><div style={styles.productName}>{p.name}</div><div style={styles.productMeta}>{p.meta}</div></div>
                  <div style={styles.productPrice}>{p.price}</div>
                </div>
              ))}
            </div>
          </div>
          <div style={styles.bentoCard}><span style={styles.bentoIcon}>🧊</span><h3 style={styles.bentoH}>See it in 3D first</h3><p style={styles.bentoP}>Preview any piece of furniture in your actual room before spending a cent.</p></div>
          <div style={styles.bentoCard}><span style={styles.bentoIcon}>🎨</span><h3 style={styles.bentoH}>Colour & layout ideas</h3><p style={styles.bentoP}>Get colour palette suggestions and layout tweaks tailored to your specific room.</p></div>
        </div>
      </div>
    </section>
  );
        ...
        {reviews.map(r => (
          <div key={r.name} style={styles.reviewCard}>
            ...
            <div style={styles.reviewer}>
              ...
              <div><div style={styles.reviewerName}>{r.name}</div><div style={styles.reviewerLoc}>{r.loc}</div></div>
            </div>
          </div>
        ))}
      </div>
    ...
    <footer style={styles.footer} className="hp-footer">
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem', width: '100%' }} className="hp-footer-inner">
        ...
        <ul style={{ margin: 0, padding: 0 }} className="hp-footer-links">
          {footerLinks.map(l => (<li key={l}><a href="#" style={styles.footerLink}>{l}</a></li>))}
        </ul>
      </div>
...
/* ─────────────────────────────────────────
   APP ROOT — HashRouter for GitHub Pages
───────────────────────────────────────── */
function App() {
  return (
    <HashRouter>
...
───────────────────────────────────────── */
const styles = {
  nav: { position: 'fixed', top: 0, left: 0, right: 0, zIndex: 200, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 3rem', height: 64, background: 'rgba(28,25,23,0.85)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)' },
  logo: { fontFamily: 'var(--serif)', fontSize: '1.4rem', fontWeight: 500, color: 'var(--ivory)', textDecoration: 'none', letterSpacing: '0.02em' },
  navLink: { fontSize: '0.88rem', color: 'var(--stone-light)', textDecoration: 'none', fontWeight: 400 },
  navBtn: { background: 'var(--rose)', color: '#fff', padding: '0.55rem 1.4rem', borderRadius: 100, fontWeight: 500, fontFamily: 'var(--sans)' },
  hero: { background: 'var(--dark)', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '8rem 2rem 5rem', position: 'relative', overflow: 'hidden' },
  heroBg: { position: 'absolute', inset: 0, pointerEvents: 'none', background: 'radial-gradient(ellipse 80% 60% at 50% 0%, rgba(232,146,124,0.12) 0%, transparent 70%)' },
  heroTag: { display: 'inline-flex', alignItems: 'center', gap: '0.5rem', background: 'rgba(232,146,124,0.12)', border: '1px solid rgba(232,146,124,0.3)', color: 'var(--rose-light)', fontSize: '0.78rem', fontWeight: 500, letterSpacing: '0.06em', textTransform: 'uppercase', padding: '0.4rem 1rem', borderRadius: 100, marginBottom: '2rem' },
  heroH1: { fontFamily: 'var(--serif)', fontSize: 'clamp(3rem, 6vw, 5.2rem)', fontWeight: 400, color: 'var(--ivory)', lineHeight: 1.1, maxWidth: 820, margin: '0 auto 1.6rem' },
  heroSub: { fontSize: 'clamp(1rem, 1.5vw, 1.15rem)', color: 'var(--stone-light)', maxWidth: 520, margin: '0 auto 2.8rem', lineHeight: 1.75, fontWeight: 300 },
  heroActions: { display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '5rem' },
  btnRose: { background: 'var(--rose)', color: '#fff', fontSize: '0.95rem', fontWeight: 500, padding: '0.85rem 2rem', borderRadius: 100, textDecoration: 'none', fontFamily: 'var(--sans)' },
  btnGhost: { background: 'transparent', color: 'var(--stone-light)', fontSize: '0.95rem', fontWeight: 400, padding: '0.85rem 2rem', borderRadius: 100, border: '1px solid rgba(168,162,158,0.3)', textDecoration: 'none' },
  dragHint: { position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', background: 'rgba(232,146,124,0.15)', border: '2px dashed var(--rose)', borderRadius: 16, color: 'var(--rose-light)', fontSize: '1.1rem', fontWeight: 500, padding: '1.5rem 3rem', pointerEvents: 'none', zIndex: 10 },
  roomCard: { flex: 1, borderRadius: 16, overflow: 'hidden', position: 'relative', aspectRatio: '4/3', background: 'var(--dark2)' },
  roomBefore: { background: 'linear-gradient(160deg, #2A2320 0%, #1E1A18 100%)' },
  roomAfter: { background: 'linear-gradient(160deg, #2C2420 0%, #3A2D26 100%)', border: '1px solid rgba(232,146,124,0.25)', boxShadow: '0 0 40px rgba(232,146,124,0.08)' },
  roomSvg: { width: '100%', height: '100%' },
  roomPill: { position: 'absolute', bottom: 14, left: '50%', transform: 'translateX(-50%)', background: 'rgba(0,0,0,0.55)', backdropFilter: 'blur(8px)', color: '#fff', fontSize: '0.72rem', fontWeight: 500, padding: '0.35rem 0.9rem', borderRadius: 100, whiteSpace: 'nowrap', letterSpacing: '0.04em' },
  suggestionFloat: { position: 'absolute', top: 14, right: 14, background: 'rgba(250,248,244,0.92)', backdropFilter: 'blur(10px)', borderRadius: 10, padding: '0.7rem 0.9rem', fontSize: '0.72rem', color: 'var(--dark)', lineHeight: 1.5, maxWidth: 150, boxShadow: '0 4px 20px rgba(0,0,0,0.2)' },
  proofBar: { background: 'var(--ivory2)', borderTop: '1px solid #E8E0D8', borderBottom: '1px solid #E8E0D8', padding: '1.6rem 2rem' },
  ...
  eyebrow: { fontSize: '0.75rem', fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--rose)', marginBottom: '1rem' },
  sectionH: { fontFamily: 'var(--serif)', fontSize: 'clamp(2rem, 3.5vw, 3rem)', fontWeight: 400, lineHeight: 1.2, color: 'var(--dark)', maxWidth: 560 },
  stepItem: { display: 'flex', flexDirection: 'column', gap: '1rem' },
  stepIconWrap: { width: 52, height: 52, borderRadius: 14, background: 'var(--rose-pale)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.4rem' },
  ...
  bentoCard: { background: 'var(--dark2)', borderRadius: 20, padding: '2.2rem 2rem', border: '1px solid rgba(255,255,255,0.06)' },
  ...
  bentoVisual: { marginTop: '2rem', background: 'rgba(255,255,255,0.04)', borderRadius: 12, padding: '1.4rem', border: '1px solid rgba(255,255,255,0.06)' },
  productRow: { display: 'flex', alignItems: 'center', gap: '1rem', padding: '0.8rem', background: 'rgba(255,255,255,0.04)', borderRadius: 10, marginBottom: '0.6rem', cursor: 'pointer' },
  ...
  reviewText: { fontFamily: 'var(--serif)', fontSize: '1rem', fontWeight: 400, color: 'var(--dark)', lineHeight: 1.65, fontStyle: 'italic', marginBottom: '1.4rem' },
  reviewer: { display: 'flex', alignItems: 'center', gap: '0.8rem' },
  reviewerAvatar: { width: 36, height: 36, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.9rem', fontWeight: 600, color: '#fff', flexShrink: 0 },
  ...
  ctaH2: { fontFamily: 'var(--serif)', fontSize: 'clamp(2.2rem, 4vw, 3.4rem)', fontWeight: 400, color: '#fff', lineHeight: 1.2, marginBottom: '1.2rem', maxWidth: 640, marginLeft: 'auto', marginRight: 'auto' },
  ctaP: { fontSize: '1rem', color: 'rgba(255,255,255,0.75)', marginBottom: '2.5rem', fontWeight: 300 },
  ctaWhite: { display: 'inline-block', background: '#fff', color: 'var(--rose)', fontSize: '0.95rem', fontWeight: 600, padding: '0.9rem 2.4rem', borderRadius: 100, textDecoration: 'none', fontFamily: 'var(--sans)' },
  footer: { background: 'var(--dark)', padding: '3rem', display: 'flex', flexDirection: 'column', gap: '0' },
  ...
  footerCopy: { fontSize: '0.75rem', color: '#44403C', width: '100%', textAlign: 'center', paddingTop: '1.5rem', borderTop: '1px solid #2A2724', marginTop: '1rem' },
};
